...
> **与官方 fnOS-Skill 的分工**：文件操作、存储管理、应用管理、系统监控等 CLI 命令由官方 `trim-cli` 提供（参见 fnOS-Skill）。本文件只包含 Hermes Agent 特有的工作流编排与规范约定。
...
> 文件系统路径查询、存储管理等通用 fnOS 操作，请使用官方 fnOS-Skill 的 `trim-cli` 对应子命令。
